...
This Worker acts as a secure proxy between the NFRAIAssets page and the OpenAI API.
...
When prompted, paste your key (it starts with `sk-...`). Press Enter.
...
- OpenAI API (gpt-4o-mini): approximately $0.002 per conversation turn.
